...
SECRET_KEY = 'django-insecure-!yt$f()9y@ctbeg#i6tiq)iygayi$q%mtm0_iune#h(l+gva!6'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {  # Adding this to ensure custom filters are recognized
...
SESSION_COOKIE_AGE = 7200    # Two weeks in seconds
